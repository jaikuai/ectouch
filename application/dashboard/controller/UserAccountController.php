...
class UserAccountController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', ['text' => $GLOBALS['_LANG']['surplus_add'], 'href' => 'user_account.php?act=add']);
            ...
            return $this->smarty->display('user_account_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            return $this->smarty->display('user_account_info.htm');
        }
        ...
        if ($_REQUEST['act'] == 'check') {
            ...
            // 如果参数不合法，返回
            if ($id == 0) {
                $this->redirect("user_account.php?act=list");
            }
            ...
            return $this->smarty->display('user_account_check.htm');
        }
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            return make_json_result($this->smarty->fetch('user_account_list.htm'), '', ['filter' => $list['filter'], 'page_count' => $list['page_count']]);
        }
