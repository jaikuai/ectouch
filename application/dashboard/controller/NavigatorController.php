...
class NavigatorController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            return $this->smarty->display('navigator.htm');
        }
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            return make_json_result($this->smarty->fetch('navigator.htm'), '', ['filter' => $navdb['filter'], 'page_count' => $navdb['page_count']]);
        }
        ...
        if ($_REQUEST['act'] == 'add') {
            if (empty($_REQUEST['step'])) {
                ...
                return $this->smarty->display('navigator_add.htm');
