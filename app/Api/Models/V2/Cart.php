...
class Cart extends BaseModel
{
    ...
    {
        $ids = self::leftJoin('goods', 'goods.goods_id', '=', 'cart.goods_id')->where('cart.user_id', $uid)->where('goods.is_on_sale', 1)->pluck('rec_id');
    ...
    {
        return $this->belongsTo('App\Api\Models\V2\Goods', 'goods_id', 'goods_id')->with('properties');
    }
