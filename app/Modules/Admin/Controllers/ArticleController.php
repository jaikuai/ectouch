...
class ArticleController extends BaseController
{
    public function actionIndex()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            return $this->smarty->display('article_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            return $this->smarty->display('article_info.htm');
        }
        ...
        if ($_REQUEST['act'] == 'insert') {
            ...
            $sql = "INSERT INTO " . $this->ecs->table('article') . "(title, cat_id, article_type, is_open, author, " .
                ...
                "'$_POST[author]', '$_POST[author_email]', '$_POST[keywords]', '$_POST[editor1]', " .
        ...
        if ($_REQUEST['act'] == 'update') {
            ...
            if ($exc->edit("title='$_POST[title]', cat_id='$_POST[article_cat]', article_type='$_POST[article_type]', is_open='$_POST[is_open]', author='$_POST[author]', author_email='$_POST[author_email]', keywords ='$_POST[keywords]', file_url ='$file_url', open_type='$open_type', content='$_POST[editor1]', link='$_POST[link_url]', description = '$_POST[description]'", $_POST['id'])) {
