...
//        if ($result === true)//注册成功
//        {
//            return sys_msg($GLOBALS['_LANG']['register_ok'], 0, $link);
//        }
//        else
//        {
...
//            return sys_msg($GLOBALS['_LANG']['register_error'] . $error_detail, 1, $link);
//        }
//
//        break;
//
...
//        if ($result === true)//启用成功
//        {
//            return sys_msg($GLOBALS['_LANG']['enable_ok'], 0, $link);
//        }
//        else
//        {
//            @$error_detail = $GLOBALS['_LANG']['server_errors'][$sms->errors['server_errors']['error_no']]
//                          . $GLOBALS['_LANG']['api_errors']['auth'][$sms->errors['api_errors']['error_no']];
//            return sys_msg($GLOBALS['_LANG']['enable_error'] . $error_detail, 1, $link);
//        }
//
//        break;
//
...
//        if ($result === true)//注销成功
//        {
//            return sys_msg($GLOBALS['_LANG']['disable_ok'], 0, $link);
//        }
//        else
//        {
//            return sys_msg($GLOBALS['_LANG']['disable_error'], 1, $link);
//        }
//
//        break;
            ...
            case 'sms_sign':
                ...
                if ($sms->has_registered()) {
                    ...
                    return $this->smarty->display('sms_sign.htm');
                } else {
                    $this->smarty->assign('ur_here', $GLOBALS['_LANG']['register_sms']);
                    $this->smarty->assign('sms_site_info', $sms->get_site_info());
...
//
//            return $this->smarty->display('sms_send_history_query_ui.htm');
//        }
//        else
//        {
//            $this->smarty->assign('ur_here', $GLOBALS['_LANG']['register_sms']);
...
//
//
//                return $this->smarty->display('sms_send_history.htm');
//            }
//            else
//            {
...
//
//                return sys_msg($GLOBALS['_LANG']['history_query_error'] . $error_detail, 1, $link);
//            }
//        }
//
//        break;
...
//            return $this->smarty->display('sms_charge_ui.htm');
//        }
//        else
//        {
//            $this->smarty->assign('ur_here', $GLOBALS['_LANG']['register_sms']);
...
//
//            return $this->smarty->display('sms_charge_history_query_ui.htm');
//        }
//        else
//        {
//            $this->smarty->assign('ur_here', $GLOBALS['_LANG']['register_sms']);
...
//
//
//                return $this->smarty->display('sms_charge_history.htm');
//            }
//            else
//            {
