    ...
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            if ($region_id > 0) {
                ...
                $action_link = ['text' => $GLOBALS['_LANG']['back_page'], 'href' => 'area_manage.php?act=list&&pid=' . $parent_id];
            } else {
                $action_link = '';
            }
            ...
            return $this->smarty->display('area_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'add_area') {
            ...
            if ($GLOBALS['db']->query($sql, 'SILENT')) {
                ...
                return make_json_result($this->smarty->fetch('area_list.htm'));
            } else {
