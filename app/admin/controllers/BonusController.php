...
class BonusController extends InitController
{
    public function actionIndex()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            return $this->smarty->display('bonus_type.htm');
        }
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            return $this->smarty->display('bonus_type_info.htm');
        }
    ...
    VALUES ('$type_name',
        ...
        if ($_REQUEST['act'] == 'send') {
            ...
            if ($_REQUEST['send_by'] == SEND_BY_USER) {
                ...
                return $this->smarty->display('bonus_by_goods.htm');
            } elseif ($_REQUEST['send_by'] == SEND_BY_PRINT) {
                $this->smarty->assign('type_list', get_bonus_type());

                return $this->smarty->display('bonus_by_print.htm');
            }
        }
        ...
        if ($_REQUEST['act'] == 'bonus_list') {
            ...
            return $this->smarty->display('bonus_list.htm');
        }
