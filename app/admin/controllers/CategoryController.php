...
class CategoryController extends InitController
{
    public function actionIndex()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            return $this->smarty->display('category_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            return make_json_result($this->smarty->fetch('category_list.htm'));
        }
            ...
            if ($this->db->autoExecute($this->ecs->table('category'), $cat) !== false) {
                ...
                if ($cat['show_in_nav'] == 1) {
                    ...
                    $sql = "INSERT INTO " . $this->ecs->table('nav') .
                        ...
                        " VALUES('" . $cat['cat_name'] . "', 'c', '" . $this->db->insert_id() . "','1','$vieworder','0', '" . build_uri('category', ['cid' => $cat_id], $cat['cat_name']) . "','middle')";
                    $this->db->query($sql);
                }
        ...
        if ($_REQUEST['act'] == 'move') {
            ...
            return $this->smarty->display('category_move.htm');
        }
