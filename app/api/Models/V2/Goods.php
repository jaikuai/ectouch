...
//        }
    ...
    {
        return $this->hasMany('App\Api\Models\V2\Tags', 'goods_id', 'goods_id');

    }

    // public function promos()
    // {
    //     return $this->hasMany('App\Api\Models\V2\GoodsActivity', 'goods_id', 'goods_id');

    // }

    public function properties()
    {
        return $this->belongsToMany('App\Api\Models\V2\Attribute', 'goods_attr', 'goods_id', 'attr_id')->where('attribute.attr_type', '!=', 0)->groupBy('attr_id');
    }

    public function attachments()
    {
        return $this->hasMany('App\Api\Models\V2\GoodsGroup', 'parent_id', 'goods_id');
    }

    public function stock()
    {
        return $this->hasMany('App\Api\Models\V2\Products', 'goods_id', 'goods_id');
    }

    public function comments()
    {
        return $this->hasMany('App\Api\Models\V2\Comment', 'id_value', 'goods_id')->where('comment.comment_type', 0)->where('comment_rank', '>', 3); //商品
    }
