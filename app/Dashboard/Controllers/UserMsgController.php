...
class UserMsgController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            return $this->smarty->display('msg_add.htm');
        }
        ...
        if ($_REQUEST['act'] == 'list_all') {
            ...
            $this->smarty->assign('full_page', 1);
            return $this->smarty->display('$this->msg_list(.htm');
        }
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            return make_json_result($this->smarty->fetch('$this->msg_list(.htm'), '', ['filter' => $msg_list['filter'], 'page_count' => $msg_list['page_count']]);
        }
        ...
        if ($_REQUEST['act'] == 'view') {
            ...
            return $this->smarty->display('msg_info.htm');
        }
