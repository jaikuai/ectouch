...
class ShopConfigController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list_edit') {
            ...
            $this->smarty->assign('group_list', $this->get_settings(null, ['5']));
            ...
            return $this->smarty->display('shop_config.htm');
        }
        ...
        if ($_REQUEST['act'] == 'mail_settings') {
            ...
            return $this->smarty->display('shop_config_mail_settings.htm');
        }
