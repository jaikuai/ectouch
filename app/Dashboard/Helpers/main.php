 ...
 * @return string
 */
function create_html_editor($input_name, $input_value = '', $width = 600, $height = 260)
{
    static $ueditor_created = false;
    $editor = '';
    if (!$ueditor_created) {
        $ueditor_created = true;
        $editor .= '<script type="text/javascript" src="' . __PUBLIC__ . '/ueditor/ueditor.config.js"></script>';
        $editor .= '<script type="text/javascript" src="' . __PUBLIC__ . '/ueditor/ueditor.all.min.js"></script>';
    }
