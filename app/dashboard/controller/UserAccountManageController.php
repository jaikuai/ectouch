...
class UserAccountManageController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            return $this->smarty->display('user_account_manage.htm');
        }
        ...
        if ($_REQUEST['act'] == 'surplus') {
            ...
            return $this->smarty->display('order_surplus_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            return make_json_result($this->smarty->fetch('order_surplus_list.htm'), '', ['filter' => $order_list['filter'], 'page_count' => $order_list['page_count']]);
        }
    }
