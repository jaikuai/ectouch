...
class RegFieldsController extends BaseController
{
    public function actionIndex()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            return $this->smarty->display('reg_fields.htm');
        }
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            $this->smarty->assign('reg_fields', $fields);
            return make_json_result($this->smarty->fetch('reg_fields.htm'));
        }
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $this->smarty->assign('action_link', ['text' => $GLOBALS['_LANG']['021_reg_fields'], 'href' => 'reg_fields.php?act=list']);
            $this->smarty->assign('form_action', $form_action);

            return $this->smarty->display('reg_field_info.htm');
        }
