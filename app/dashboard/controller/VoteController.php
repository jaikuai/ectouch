...
class VoteController extends BaseController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            return $this->smarty->display('vote_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            return $this->smarty->display('vote_info.htm');
        }
        ...
        if ($_REQUEST['act'] == 'option') {
            ...
            return $this->smarty->display('vote_option.htm');
        }
        ...
        if ($_REQUEST['act'] == 'query_option') {
            ...
            return make_json_result($this->smarty->fetch('vote_option.htm'));
        }
