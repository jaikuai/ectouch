...
class VirtualCardController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'replenish') {
            ...
            return $this->smarty->display('replenish_info.htm');
        }
        ...
        if ($_REQUEST['act'] == 'card') {
            ...
            return $this->smarty->display('replenish_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'batch_card_add') {
            ...
            $this->smarty->assign('goods_id', $_REQUEST['goods_id']);
            return $this->smarty->display('batch_card_info.htm');
        }
        ...
        if ($_REQUEST['act'] == 'batch_confirm') {
            ...
            return $this->smarty->display('batch_card_confirm.htm');
        }
        ...
        if ($_REQUEST['act'] == 'change') {
            ...
            return $this->smarty->display('virtual_card_change.htm');
        }
