...
class AdsController extends BaseController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', ['text' => $GLOBALS['_LANG']['ads_add'], 'href' => 'ads.php?act=add']);
            ...
            return $this->smarty->display('ads_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            return $this->smarty->display('ads_info.htm');
        }
