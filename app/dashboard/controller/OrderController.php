...
class OrderController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'order_query') {
            ...
            $this->smarty->assign('action_link', ['href' => 'order.php?act=list', 'text' => $GLOBALS['_LANG']['02_order_list']]);

            return $this->smarty->display('order_query.htm');
        }
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', ['href' => 'order.php?act=order_query', 'text' => $GLOBALS['_LANG']['03_order_query']]);
            ...
            return $this->smarty->display('order_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            return make_json_result($this->smarty->fetch('order_list.htm'), '', ['filter' => $order_list['filter'], 'page_count' => $order_list['page_count']]);
        }
        ...
        if ($_REQUEST['act'] == 'info') {
            ...
            elseif (isset($_GET['shipping_print'])) {
                ...
                if ($shipping['print_model'] == 2) {
                    ...
                    return $this->smarty->display('print.htm');
                ...
                $this->smarty->assign('action_link', ['href' => 'order.php?act=list&' . list_link_postfix(), 'text' => $GLOBALS['_LANG']['02_order_list']]);

                // 显示模板

                return $this->smarty->display('order_info.htm');
            }
        }
        ...
        if ($_REQUEST['act'] == 'delivery_list') {
            ...
            return $this->smarty->display('delivery_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'delivery_query') {
            ...
            $this->smarty->assign($sort_flag['tag'], $sort_flag['img']);
            return make_json_result($this->smarty->fetch('delivery_list.htm'), '', ['filter' => $result['filter'], 'page_count' => $result['page_count']]);
        }
        ...
        if ($_REQUEST['act'] == 'delivery_info') {
            ...
            $this->smarty->assign('action_link', ['href' => 'order.php?act=delivery_list&' . list_link_postfix(), 'text' => $GLOBALS['_LANG']['09_delivery_order']]);
            $this->smarty->assign('action_act', ($delivery_order['status'] == 2) ? 'delivery_ship' : 'delivery_cancel_ship');

            return $this->smarty->display('delivery_info.htm');
            exit; //
        }
        ...
        if ($_REQUEST['act'] == 'back_list') {
            ...
            return $this->smarty->display('back_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'back_query') {
            ...
            $sort_flag = sort_flag($result['filter']);
            $this->smarty->assign($sort_flag['tag'], $sort_flag['img']);
            return make_json_result($this->smarty->fetch('back_list.htm'), '', ['filter' => $result['filter'], 'page_count' => $result['page_count']]);
        }
        ...
        if ($_REQUEST['act'] == 'back_info') {
            ...
            $this->smarty->assign('action_link', ['href' => 'order.php?act=back_list&' . list_link_postfix(), 'text' => $GLOBALS['_LANG']['10_back_order']]);

            return $this->smarty->display('back_info.htm');
        }
...
//        }
            ...
            return $this->smarty->display('order_step.htm');
        }
        ...
        if ($_REQUEST['act'] == 'process') {
            ...
            elseif ('load_refund' == $func) {
                ...
                return $this->smarty->display('order_refund.htm');
            } else {
                die('invalid params');
            }
        }
        ...
        if ($_REQUEST['act'] == 'merge') {
            ...
            return $this->smarty->display('merge_order.htm');
        }
        ...
        if ($_REQUEST['act'] == 'templates') {
            ...
            create_html_editor('editor1', $file_content);
            ...
            return $this->smarty->display('order_templates.htm');
        }
        ...
        if ($_REQUEST['act'] == 'edit_templates') {
            ...
            @fwrite($file_name, stripslashes($_POST['editor1']));
            @fclose($file_name);
        ...
        if ($_REQUEST['act'] == 'operate') {
            ...
            elseif (isset($_POST['ship'])) {
                ...
                return $this->smarty->display('order_delivery_info.htm');
                exit;
            } // 未发货
            ...
            if (($require_note && $action_note == '') || isset($show_invoice_no) || isset($show_refund)) {
                ...
                return $this->smarty->display('order_operate.htm');
            } else {
                // 直接处理
                if (!$batch) {
                    // 一个订单
...
//    $action_note = $_REQUEST['action_note'];
            ...
            if (empty($sn_not_list)) {
                ...
                return $this->smarty->display('order_operate_info.htm');
            }
        }
    ...
    private function handle_order_money_change($order, &$msgs, &$links)
    {
        ...
        if ($order['pay_status'] == PS_PAYED || $order['pay_status'] == PS_PAYING) {
            ...
            if ($money_dues > 0) {
                ...
                $links[] = ['text' => $GLOBALS['_LANG']['refund'], 'href' => 'order.php?act=process&func=load_refund&anonymous=' .
