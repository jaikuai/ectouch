...
class MessageController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            return $this->smarty->display('message_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            return make_json_result($this->smarty->fetch('message_list.htm'), '',
        ...
        if ($_REQUEST['act'] == 'send') {
            ...
            return $this->smarty->display('message_info.htm');
        }
        ...
        if ($_REQUEST['act'] == 'view') {
            ...
            return $this->smarty->display('message_view.htm');
        }
