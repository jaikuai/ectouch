...
class ShippingAreaController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            return $this->smarty->display('shipping_area_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'add' && !empty($_REQUEST['shipping'])) {
            ...
            return $this->smarty->display('shipping_area_info.htm');
        }
...
//       }
        ...
        if ($_REQUEST['act'] == 'remove_area') {
            ...
            $list = $this->get_shipping_area_list($shipping_id);
            $this->smarty->assign('areas', $list);
            return make_json_result($this->smarty->fetch('shipping_area_list.htm'));
        }
    }
