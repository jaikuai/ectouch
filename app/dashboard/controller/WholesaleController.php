...
class WholesaleController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', ['href' => 'wholesale.php?act=add', 'text' => $GLOBALS['_LANG']['add_wholesale']]);
            $this->smarty->assign('action_link2', ['href' => 'wholesale.php?act=batch_add', 'text' => $GLOBALS['_LANG']['add_batch_wholesale']]);
            ...
            return $this->smarty->display('wholesale_list.htm');
        }
        ...
        if ($_REQUEST['act'] == 'batch_add') {
            ...
            $this->smarty->assign('action_link', ['href' => $href, 'text' => $GLOBALS['_LANG']['wholesale_list']]);

            return $this->smarty->display('wholesale_batch_info.htm');
        }
        ...
        if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            return $this->smarty->display('wholesale_info.htm');
        }
